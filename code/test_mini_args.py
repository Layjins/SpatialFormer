...
def argument_parser():
    ...
    # neck
    parser.add_argument('--neck', default='tSF_novel', help="None, Coarse_feat, Fine_feat, Task_feat, Coarse_Fine, Coarse_Task, Coarse_Fine_Task, \
                        tSF_novel, tSF_stacker1, tSF_stacker2, tSF_encoder2, SIQ_encoder2, SIQ_encoder3, CECE")
    ...
    parser.add_argument('--novel2base_feat', default="None", help="update the base-pattern feature by using novel classifier in test stage: None, SimMapAttention, ClassWeightAttention, ClassWeightAttentionGT, ThreshClassAttention")
    ...
    parser.add_argument('--resume', type=str, default='/persons/jinxianglai/FewShotLearning/few-shot_classification/CAN_output/miniImageNet/2023.01.30.17.50.52/best_model.pth.tar', metavar='PATH')
    # FewShot settting
