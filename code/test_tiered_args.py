...
def argument_parser():
    ...
    parser.add_argument('--backbone', default='ResNet12_BDC', 
    ...
    parser.add_argument('--global_classifier_attention', default="TSCA", help="global classifier attention: None, ClassWeightAttention, ThreshClassAttention, TSCA, TCA")
    ...
    parser.add_argument('--attention', default="TSIA", help="attention module: None, CAM, DGC_CAM, SuperGlue, LoFTR, NLBlockND_CAM, NLCAM, TCAM, CECM, TSIA, TIA")
    ...
    parser.add_argument('--fine_tune', default=True, help="fine tuning in the test stage")
    ...
    parser.add_argument('--novel_classifier', default="ProtoInitConv1", help="novel classifier by fineturning in test stage: Linear, distLinear, Conv1, ProtoInitDistLinear, ProtoInitConv1")
    ...
    parser.add_argument('--novel_metric_classifier', default=True, help="metric-based classifier to classify the novel feature")
    parser.add_argument('--novel2base_feat', default="ClassWeightAttention", help="update the base-pattern feature by using novel classifier in test stage: None, SimMapAttention, ClassWeightAttention")
    ...
    parser.add_argument('--save-dir', type=str, default='/persons/jinxianglai/FewShotLearning/few-shot_classification/CAN_output/test/{}'.format(time.strftime('%Y.%m.%d.%H.%M.%S', time.localtime(time.time()))))
    parser.add_argument('--fix_backbone', default=True, help="fix backbone in training")
    parser.add_argument('--load_backbone', default=False, help="only load the backbone in training")
    parser.add_argument('--resume', type=str, default='/persons/jinxianglai/FewShotLearning/few-shot_classification/CAN_output/tieredImageNet/2022.07.22.17.51.50/best_model.pth.tar', metavar='PATH')
    # FewShot settting
    parser.add_argument('--nKnovel', type=int, default=5,
                        help='number of novel categories')
    parser.add_argument('--nExemplars', type=int, default=10,
