...
class WideResNet(nn.Module):
    def __init__(self, depth=28, widen_factor=10, norm_layer=nn.BatchNorm2d, num_classes= 200 , loss_type = 'dist', per_img_std = False, stride = 1 ):
        dropRate = 0.5
        flatten = True
...
def wrn28_10_cam(norm_layer=nn.BatchNorm2d, num_classes=200, loss_type = 'dist'):
    model = WideResNet(depth=28, widen_factor=10, norm_layer=norm_layer, num_classes=num_classes, loss_type = loss_type , per_img_std = False, stride = 1 )
    return model
