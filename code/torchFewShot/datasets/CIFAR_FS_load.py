...
class CIFAR_FS_load(object):
    """
    Dataset statistics:
    # 64 * 600 (train) + 16 * 600 (val) + 20 * 600 (test)
    """
    dataset_dir = '/persons/jinxianglai/FewShotLearning/IMLN/CIFAR-FS/CIFAR-FS/'

    def __init__(self, **kwargs):
        super(CIFAR_FS_load, self).__init__()
        ...
        #self.train, self.train_labels2inds, self.train_labelIds = self._process_dir2(self.train_dir, self.val_dir) # train+val
