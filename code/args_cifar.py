...
def argument_parser():
    ...
    # Datasets (general)
    # ************************************************************
    parser.add_argument('-d', '--dataset', type=str, default='CIFAR_FS_load',help="CIFAR_FS, CIFAR_FS_load")
    parser.add_argument('--load', default=True,help="CIFAR_FS=False, CIFAR_FS_load=True")

    parser.add_argument('-j', '--workers', default=0, type=int,
                        help="number of data loading workers (default: 0)")
    parser.add_argument('--org_height', type=int, default=32, help="height of an image")
    parser.add_argument('--height', type=int, default=84,
                        help="height of an image (default:32)")
    parser.add_argument('--width', type=int, default=84,
                        help="width of an image (default: 32)")
    ...
    # Miscs
    # ************************************************************
    parser.add_argument('--save-dir', type=str, default='/persons/jinxianglai/FewShotLearning/few-shot_classification/CAN_output/CIFAR_FS/{}'.format(time.strftime('%Y.%m.%d.%H.%M.%S', time.localtime(time.time()))))
